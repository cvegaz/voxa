...
Sends user context and column schema to the Claude API to generate
...
class LLMEnrichmentService:
    """Generates enriched context by calling Claude with user context + schema."""
    ...
    def _build_prompt(self, context: str, schema: ColumnSchema) -> str:
    ...
    async def enrich(self, context: str, schema: ColumnSchema) -> str:
        """Send context + schema to Claude and return the enriched context.
        ...
        Returns:
            The enriched context string generated by Claude.

        Raises:
            LLMUnavailableError: If Claude is unreachable after retries.
            LLMInvalidResponseError: If Claude returns an empty or invalid response.
        """
